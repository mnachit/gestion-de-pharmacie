            ...
            <nav class="navbar bg-secondary navbar-dark">
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/username/{{Auth::user()->image }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <a href="/index" class="nav-item nav-link active text-light mt-4"><i class="bi bi-bag-plus-fill me-2"></i>Home</a>
                    <a href="/Home" class="nav-item nav-link active text-light mt-4"><i class="bi bi-bag-plus-fill me-2"></i>dashbord</a>
                    ...
                    <a href="/Add_Prduct" class="nav-item nav-link active text-light mt-4"><i class="bi bi-bag-plus-fill me-2"></i>Add Product</a>
                    <a href="{{route('Dash.receiving_requests')}}" class="nav-item nav-link active text-light mt-4"><i class="bi bi-bag-check-fill me-1"></i>Receiving requests</a>
                    <a href="{{route('Dash.pharmacy')}}" class="nav-item nav-link active text-light mt-4"><i class="bi bi-person-lines-fill me-2"></i>Pharmacy</a>
                    <a href="{{route('Dash.buyer')}}" class="nav-item nav-link active text-light mt-4"><i class="fa-solid fa-users me-2"></i>Buyer</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4">
                    <input class="form-control bg-dark border-0" type="text" id="searchbar" onkeyup="search_animal()" placeholder="Search">
                </form>
