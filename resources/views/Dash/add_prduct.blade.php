        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <button type="button" class="btn btn-success" id="addsongs" href="#modal-task2" data-bs-toggle="modal">Add Product</button>
                </div>
                        ...
                        <tbody>
                            @foreach ($Data_Product as $info)
                                    <tr>
                                        ...
                                        <td><img src="{{asset("img/blogs/$info->image")}}" width= '60' height='60' class="rounded-circle img img-responsive" alt=""></td>
                                        <td>{{$info->date}}</td>
                                        <td>{{$info->Name}}</td>
                                        ...
                                        <td>
                                            <div class="d-flex flex-row">
                                                <button class="rounded updateBtn me-3" data-bs-toggle="modal" data-bs-target="#modal-edit" style="background-color: rgb(140, 147, 169);">
    ...
    function name(id) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200)
            {
                ...
                document.getElementById('img').src = 'img/blogs/'+data.image;
