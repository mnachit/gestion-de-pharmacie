...
<body>
	...
	<table>
      ...
      @foreach ($order as $key => $data)
			<tr>
        <td>{{$key +1}}</td>
        <td><img src="{{$data->image}}" alt="" style="border-radius: 50%; width: 100px; height: 100px;"></td>
        <td>{{$data->Name}}</td>
	...
	<p>Thank you for choosing Phama-nachit. If you have any questions or concerns about your order, please don't hesitate to contact us:</p>
