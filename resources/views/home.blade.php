                    ...
                    <div class="main-nav d-none d-lg-block">
                        <nav class="site-navigation text-right text-md-center" role="navigation">
                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li class="{{ request()->is('Shop') ? 'active' : '' }}"><a href="{{ url('/Shop') }}">Store</a></li>
                        ...
                        <div class="nav-item dropdown float-right mb-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                                ...
                                @auth
                                    ...
                                    @endif
                                @endauth
                                <a href="{{ route('tracking') }}" class="dropdown-item">order tracking</a>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <div class="block-7">
                            ...
                            <p>Welcome to our parapharmacie, where we provide high-quality health and wellness products
                                to help you feel your best.</p>
                        </div>
